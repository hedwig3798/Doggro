...
ChairCollider::ChairCollider(std::string _name, ManagerSet* _managerSet, OBJECT_TYPE _type, LoadMapData* _objectManager)
	: Entity(_name, _managerSet, _type)
{
	...
	GetComponent<Transform>()->SetPosition(Vector3(47.f, 40.9907f, 134.f));

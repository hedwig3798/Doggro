...
Chair3Collider::Chair3Collider(std::string _name, ManagerSet* _managerSet, OBJECT_TYPE _type, LoadMapData* _objectManager)
	: Entity(_name, _managerSet, _type)
{
	...
	GetComponent<Transform>()->SetPosition(Vector3(100.f, 40.9907f, 0.f));
	...
	GetComponent<StaticCollider>()->SetSize(Vector3(84.866f, 60.281f, 80.773f));
	GetComponent<StaticCollider>()->Start();
}

Chair3Collider::~Chair3Collider()
{

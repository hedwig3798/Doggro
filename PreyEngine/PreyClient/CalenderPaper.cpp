...
CalenderPaper::CalenderPaper(std::string _name, ManagerSet* _managerSet, OBJECT_TYPE _type, LoadMapData* _objectManager, QuestManager* _questManager, DogScript* _dogScript)
...
CalenderPaper::~CalenderPaper()
{

}

void CalenderPaper::Update(float _deltaTime)
{

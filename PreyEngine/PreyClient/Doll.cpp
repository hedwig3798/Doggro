...
Doll::Doll(std::string _name, ManagerSet* _managerSet, OBJECT_TYPE _type, LoadMapData* _objectManager, QuestManager* _questManager, DogScript* _dogScript)
	: Entity(_name, _managerSet, _type)
{
	...
	CreateComponent<DollScript>(this);
	GetComponent<DollScript>()->GetQuestManager(questManager);
...
void Doll::Update(float _deltaTime)
{

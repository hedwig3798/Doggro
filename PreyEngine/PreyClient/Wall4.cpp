...
Wall4::Wall4(std::string _name, ManagerSet* _managerSet, OBJECT_TYPE _type, LoadMapData* _objectManager)
	:Entity(_name, _managerSet, _type)
{
	...
	GetComponent<Transform>()->SetPosition(Vector3(330.f, 100.f, 0.f));

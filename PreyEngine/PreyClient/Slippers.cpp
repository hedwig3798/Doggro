...
Slippers::Slippers(std::string _name, ManagerSet* _managerSet, OBJECT_TYPE _type, LoadMapData* _objectManager, DogScript* _dogScript)
...
void Slippers::Update(float _deltaTime)
{

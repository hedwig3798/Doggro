...
ShoeRack::ShoeRack(std::string _name, ManagerSet* _managerSet, OBJECT_TYPE _type, LoadMapData* _objectManager)
	: Entity(_name, _managerSet, _type)
{
	...
	Vector3 cscale(aBoundingBox.xLen * 100+50, aBoundingBox.yLen * 100+30, aBoundingBox.zLen * 100+50);

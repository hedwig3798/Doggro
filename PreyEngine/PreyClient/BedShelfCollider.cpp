...
BedShelfCollider::BedShelfCollider(std::string _name, ManagerSet* _managerSet, OBJECT_TYPE _type, LoadMapData* _objectManager)
	: Entity(_name, _managerSet, _type)
{
	...
	GetComponent<Transform>()->SetPosition(Vector3(-61.f, 70.9907f, 226.f));
	...
	GetComponent<StaticCollider>()->SetSize(Vector3(150.866f, 81.281f, 100.773f));
	GetComponent<StaticCollider>()->Start();
}

BedShelfCollider::~BedShelfCollider()
{

...
inline DirectX::SimpleMath::Rectangle DirectX::SimpleMath::Rectangle::Intersect(const Rectangle& ra, const Rectangle& rb) noexcept
{
...
inline DirectX::SimpleMath::Rectangle DirectX::SimpleMath::Rectangle::Union(const Rectangle& ra, const Rectangle& rb) noexcept
{
	long righta = ra.x + ra.width;
	long rightb = rb.x + rb.width;

...
physx::ShoebillPxErrorCallback::ShoebillPxErrorCallback()
{
...
void physx::ShoebillPxErrorCallback::reportError(PxErrorCode::Enum code, const char* message, const char* file, int line)
{
